/*
  ...
  26.06.2023
    ...
    - Оптимизация: убрал DateTime в MicroDS3231 - (гл.пер.\память 1650\30784)
    - Оптимизация: убрал пины в StepMotor - (гл.пер.\память 1646\30714)
    - Оптимизация: ControlTemp сменил библиотеку DS18B20.h на легкую microDS18B20.h - (гл.пер.\память 1624\29910)
    - Оптимизация: ControlTemp рефакторинг readTemperatureNeedDisplay (гл.пер.\память 1624\29874)
    - Оптимизация: убрал пин в Melody.h + рефакторинг - (гл.пер.\память 1624\29820)
