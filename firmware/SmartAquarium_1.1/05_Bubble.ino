...
void onTheBubble(byte _events) {
  ...
  else if (currMode.main == 3 && currMode.secondary == 4) {
    // считываний сенсора в секунду
    if ((_events & 0b00000010) == 0b00000010) _needDisplay = true;
  }
  else if ((currMode.main == 2 && currMode.secondary == 0) || (currMode.main == 3 && currMode.secondary != 0 && currMode.secondary != 1 && currMode.secondary != 6)) {
