/*
  ...
  12.07.2023
    - Вывели приветственную надпись (гл.пер.\память 1654\28716)
    - Объединил весь анализ клавиатуры из LoopTime в Menu (гл.пер.\память 1650\28600)
    - Перенес функционал мигания из Menu в LoopTime - ведь он временной (гл.пер.\память 1650\28598)
    - Menu - убрал неиспользуемые подменю (гл.пер.\память 1624\28430)
    - Восстановил вывод продолжительности (гл.пер.\память 1620\28548)
    - Через вывод продолжительности восстановил диагностику задержки menu.display() до 4 мс. - нужна оптимизация (гл.пер.\память 1624\28686)
    - Исправил ошибки BubbleControl, исправил диагностику продолжительности (гл.пер.\память 1624\28698)
    - Исправил найденные ошибки: Menu (гл.пер.\память 1624\28698)
